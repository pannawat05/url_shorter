...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full float-end mr-25 mt-5"><a href="/new">  <span class="mr-1">🔗</span>shorten another urls</a></button>
...
<div class="p-6 max-w-6xl mx-auto mt-25">
    ...
    {:else if error}
        <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-4">
            ...
            {#if !token}
                <a href="/login" class="text-red-800 underline font-bold mt-2 inline-block">Go to login</a>
            {/if}
        </div>
    {:else}
        {#if urls && urls.length > 0}
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 border-b">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 w-1/3 text-center">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {#each urls as url}
            ...
            >
              ...
              {/if}
                                ...
                                <td class="px-6 py-4">
                                    <div class="max-w-md md:max-w-xl truncate text-gray-400 italic" title={url.original_url}>
                                        {url.original_url}
                                    </div>
