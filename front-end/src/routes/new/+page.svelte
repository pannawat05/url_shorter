...
<div class="min-h-screen bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 flex items-center justify-center p-4 relative overflow-hidden">
  ...
  <div class="absolute inset-0 overflow-hidden pointer-events-none">
    ...
    <div class="absolute -bottom-1/2 -right-1/2 w-96 h-96 bg-purple-300 rounded-full mix-blend-overlay filter blur-3xl opacity-20 animate-pulse" style="animation-delay: 1.5s;"></div>
    <div class="absolute top-1/2 left-1/2 w-64 h-64 bg-blue-300 rounded-full mix-blend-overlay filter blur-3xl opacity-10 animate-pulse" style="animation-delay: 0.5s;"></div>
  </div>

  <!-- Main container -->
  <div class="relative w-full max-w-2xl">
    <div class="absolute -inset-1 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-3xl blur-lg opacity-75"></div>

    <div class="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12">
      <!-- Header -->
      <div class="text-center mb-10">
        <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-600 rounded-3xl mb-6 shadow-xl transform hover:scale-110 transition-all duration-300 hover:rotate-6 cursor-pointer">
        ...
        <h1 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent mb-4 flex items-center justify-center gap-2">
         new short URL
      ...
      <!-- Error message -->
      {#if errorMessage}
        <div class="mb-6 bg-red-50 border-2 border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm flex items-start gap-2">
      ...
      <div class="space-y-6">
        <div class="relative group">
          <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
            <svg class={"w-5 h-5 transition-colors duration-200 " + (focused ? 'text-indigo-500' : 'text-gray-400')} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Result -->
      {#if shortenedUrl}
        <div class="mt-8 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-indigo-200 rounded-2xl">
          ...
          <div class="flex items-center gap-3 bg-white p-4 rounded-xl border border-indigo-200">
            <a
              href={shortenedUrl}
              target="_blank"
          ...
          {#if copied}
            <p class="text-green-600 text-sm font-medium mt-3 text-center animate-pulse">
              ✓ Copied to clipboard!
            </p>
          {/if}
      ...
      <!-- Features -->
      <div class="mt-10 grid grid-cols-3 gap-4 pt-8 border-t border-gray-200">
        <div class="text-center">
          <div class="text-3xl mb-2">⚡</div>
          <div class="text-sm font-semibold text-gray-700">Fast</div>
          <div class="text-xs text-gray-500 mt-1">Instant results</div>
        </div>
        <div class="text-center">
          <div class="text-3xl mb-2">🎁</div>
